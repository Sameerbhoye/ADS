...
statement: Given two arrays s[] and E[] of size N denoting starting and closing time of the shops and an integer values k denoting the number of people the task is to find out the max number of shops they can visit in total if they visit each shop optimally based on following conditions:
* A shop can be visited by only one person 
* A person cannot visit another shop if its time is collide with it 
Input s[] ={1,8,2,6}, e[]={5,10,6,5,9}, k=2;
output 4
